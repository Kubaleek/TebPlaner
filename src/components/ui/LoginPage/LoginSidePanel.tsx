...
import LogoV1 from '../../../../public/teb.png';
import LogoV2 from '../../../../public/teb2.png';
...
export default function LoginGraphic() {
    return (
        ...
        <GridPattern x={12} className="stroke-[#ff828a] fill-[#ff828a] [mask-image:radial-gradient(300px_circle_at_bottom_left,white,transparent)] xl:[mask-image:radial-gradient(600px_circle_at_bottom_left,white,transparent)]" />
        <Image
          src={LogoV2}
        ...
        <div className="relative justify-center items-center flex w-full py-8">
          <div className="flex flex-col gap-5 justify-center items-center">
            <h1 className="lg:text-4xl televisor:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-br  from-white to-[#fafafa] bg-opacity-50">
              Teb Technikum i Liceum Łódź
            </h1>
