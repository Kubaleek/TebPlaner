...
export default function LoginForms() {
  ...
  return (
    <div className="col-span-12 lg:col-span-6 h-full flex z-[0] lg:h-screen relative flex-col justify-center items-center loginBackground border-solid">
      ...
      />
      <div className="relative border bg-[#ff828a] shadow-form flex-col justify-center flex items-center lg:justify-start lg:items-center bg-opacity-5 border-[#ff828a]  backdrop-blur-3xl w-full lg:w-[400px] lg:h-[600px]  xl:w-[500px] h-full xl:h-[600px] rounded-md z-[1] lg:py-12 p-6">
        <DotPattern className="w-32 absolute top-0 left-0 p-4 h-32 text-[#fafafa] lg:hidden" />
        <DotPattern className="w-32 absolute top-auto left-auto p-4 h-32 text-[#fafafa] lg:hidden" />
        <div className="flex flex-col gap-8 w-full max-w-xs">
          ...
          <div className="flex flex-col gap-5">
            <form className="flex flex-col gap-6">
              ...
              <Button
                type="submit"
                className="rounded-none rounded-e-lg bg-red-50 border text-red-900 placeholder-red-400 focus:outline-none hover:bg-red-200 text-base  block flex-1 min-w-0 w-full border-red-300 p-2.5"
              >
                Zaloguj się
              </Button>
            </form>
